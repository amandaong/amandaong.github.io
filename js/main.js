...
$(document).ready(function () {
    ...
    $(".about .iconImage.linkedIn").hover(
        function () {
            $(".about .iconImage.linkedIn").css('background-image', 'url(../amandaong.github.io/images/linkedinhover.png)');
            $(".about .iconTitle.linkedIn").css('color', 'rgb(130,130,130)');
        },
        function () {
            $(".iconImage.linkedIn").css('background-image', 'url(../amandaong.github.io/images/linkedin.png)');
